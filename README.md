...
## ОТВЕТ
https://hub.docker.com/repository/docker/mteplov81/custom-nginx/general
...
Контейнер останавливался при Ctrl-C — это нормально для интерактивной сессии.

После изменения порта проверка curl показала новый порт.
